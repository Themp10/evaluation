...
CREATE TABLE IF NOT EXISTS `evolution` (
  ...
  `motivation` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `avis` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `formations` (
  ...
  `annee` int DEFAULT NULL,
  `user` int DEFAULT NULL,
  `formation` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `obj_formation` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `formations` (`id`, `id_ligne`, `annee`, `user`, `formation`, `obj_formation`, `priorite`) VALUES
	(11, 0, 2025, 3, 'eeeee', 'eeee', 2),
	(12, 1, 2025, 3, 'fff', 'ffff', 3);
...
CREATE TABLE IF NOT EXISTS `objectifs` (
  ...
  `annee` int DEFAULT NULL,
  `user` int DEFAULT NULL,
  `objectif` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `indicateur` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `realisation` int DEFAULT '0',
  `score` int DEFAULT '1',
  `resultat_analyse` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `echeance` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `validation` int DEFAULT '0',
  `validation2` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table evaluation.objectifs : ~9 rows (environ)
INSERT INTO `objectifs` (`id`, `id_ligne`, `annee`, `user`, `objectif`, `indicateur`, `realisation`, `score`, `resultat_analyse`, `echeance`, `validation`, `validation2`) VALUES
	...
	(30, 0, 2025, 3, 'azzzz', 'zzzz', 0, 1, NULL, 'zzz', 0, 0),
	(31, 1, 2025, 3, 'ffffgf', 'gggggg', 0, 1, NULL, 'Apv-25', 0, 0),
	(32, 2, 2025, 3, 'rrrr', 'rr', 0, 1, NULL, 'gg', 0, 0);
...
-- Listage des données de la table evaluation.scores : ~0 rows (environ)
...
CREATE TABLE IF NOT EXISTS `set_softskills` (
  ...
  `nom_ss` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `softskills` (
  ...
  `annee` int DEFAULT NULL,
  `user` int DEFAULT NULL,
  `id_ss` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `point` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `softskills` (`id`, `annee`, `user`, `id_ss`, `point`, `score`, `commentaire`, `validation`, `validation2`) VALUES
	(1, 2024, 3, '1', 'progret', 3, 'gfgdfg', 1, 0),
	...
	(13, 2024, 3, '13', 'fort', 1, 'a', 1, 0),
	(14, 2024, 3, '14', 'fort', 4, 'aggg', 1, 0);

-- Listage de la structure de la table evaluation. users
CREATE TABLE IF NOT EXISTS `users` (
  `id` int NOT NULL AUTO_INCREMENT,
  `login` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  ...
  `direction` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `poste` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `responsable` int NOT NULL DEFAULT '0',
  `pwd` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `collaborateurs` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Listage des données de la table evaluation.validation : ~1 rows (environ)
INSERT INTO `validation` (`id`, `annee`, `user`, `valideur1`, `validation1`, `valideur2`, `validation2`) VALUES
	(1, 2025, 3, 2, 0, 1, 0);
